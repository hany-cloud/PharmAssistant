...
$('.checkDateNoGraterThanToday').on('blur', function () {
    ...
    if (inputDate.setHours(0, 0, 0, 0) > todaysDate.setHours(0, 0, 0, 0)) {
        ...
        sweetAlert("Validation Error", 'Date set is greater than current date!', "error");
...
$('.checkDateNoLessThanToday').on('blur', function () {
    ...
    if (inputDate.setHours(0, 0, 0, 0) <= todaysDate.setHours(0, 0, 0, 0)) {
        ...
        sweetAlert("Validation Error", 'Expiry Date should be greater than current date!', "error");
...
$('.CheckFirstCharIsZero').on('blur', function () {
    ...
    if (x.charAt(0)==0) {
        ...
        sweetAlert("Validation Error", 'Cannot start with Zero !!', "error");
